...
/*        if (Input.GetMouseButtonUp(0))
    ...
    private void HandleRopeUnwrap()
    {
        ...
        // Hinge = ñëåäóþùàÿ òî÷êà ââåðõ îò ïîçèöèè èãðîêà
        // Anchor = ñëåäóþùàÿ òî÷êà ââåðõ îò Hinge
        // Hinge Angle = óãîë ìåæäó anchor è hinge
        // Player Angle = óãîë ìåæäó anchor è player
